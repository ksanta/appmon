# Creates a single graph for all transactions showing arrival rate over time.
# Given filename can be a regular expression so that it matches multiple files.
# Default grouping is 5 minute intervals, though this can be changed with binPeriod

gradeOfService <- function(file, startHour = 0, endHour = 24, quantile=0.95, binPeriod = "5 min", combineFiles = FALSE) {
